...
def tasks_healthcheck():
    ...
    with open(metrics_output_file, 'a') as f:
        f.write('Task Metrics - ' + datetime.now().strftime('%m/%d/%Y, %H:%M:%S') + '\n')
        f.write('\n')   
        f.write('Total task templates configured: ' + str(metric_templates) + '\n')
        f.write('\n')
        f.write('Recurring tasks: ' + str(metric_tasks_recurring) + '\n')
        f.write('\n')
        f.write(' Analysis tasks: ' + str(metric_recurring_tasks_analysis) + '\n')
        f.write(' Connector tasks: ' + str(metric_recurring_tasks_connector) + '\n')
        f.write(' Sample tasks: ' + str(metric_recurring_tasks_sample) + '\n')
        f.write(' Scan tasks: ' + str(metric_recurring_tasks_scan) + '\n')
        f.write('\n')
        ...
        f.write('\n')
        f.write(' Recurring tasks using a template: ' + str(metric_recurring_tasks_using_template) + '\n')
        f.write('\n')
        f.write('Metrics for last 1000 tasks:\n')
        f.write('\n')
        ...
        f.write('\n')
        f.write(' Scan tasks configured with a template: ' + str(metric_tasks_using_template) + '\n')
        f.write('\n')
        f.write('Error messages seen in last 1000 tasks:\n')
        f.write('\n')
