...
def explorers_healthcheck():
    ...
    with open(metrics_output_file, 'a') as f:
        ...
        f.write('\n')
        f.write('Latest runZero explorer version: ' + current_version + '\n')
        f.write('Minimum recommended explorer memory: ' + str(recommended_explorer_memory_GiB) + 'GiB (' + str(recommended_explorer_memory_bytes) + 'bytes )\n')
        f.write('\n')
        f.write('Total number of explorers: ' + str(metric_explorer_count) + ' explorers across ' + str(metric_org_count) + ' organizations.\n')
        f.write('Number of explorers running latest version: ' + str(metric_up_to_date_explorers) + '\n')
        f.write('Number of explorers not running latest version: ' + str(metric_out_of_date_explorers) + '\n')
        f.write('Number of online explorers: ' + str(metric_online_explorers) + '\n')
        f.write('Number of offline explorers: ' + str(metric_offline_explorers) + '\n')
        f.write('Number of explorers with passive sampling enabled: ' + str(metric_passive_sampling) + '\n')
        f.write('Number of explorers that support screenshots: ' + str(metric_supports_screenshots) + '\n')
        f.write('Number of explorers below recommended memory allocation: ' + str(metric_memory_allocation) + '\n')
        f.write('----------------------------------------------------------------\n')
